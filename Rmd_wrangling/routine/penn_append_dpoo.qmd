...
stop("need to drop nulls here!")
tray = compare_for_staging(db_visit %>% collect(), subset_aural_visit, tbl_nkey('visit', mdc))
final_aural_visit = bind_rows(tray$insert,
                              tray$update)
# survey
subset_aural_survey = gelled_aural %>%
  select(any_of(colnames(db_survey)))
tray = compare_for_staging(db_visit %>% collect(), subset_aural_survey, tbl_nkey('survey', mdc))
...
tray = compare_for_staging(db_visit %>% collect(), subset_aural, tbl_nkey('aural', mdc))
