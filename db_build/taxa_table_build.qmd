...
taxa_rp = replace_taxa("esparadana prosoblepon", "espadarana prosoblepon", path = taxa_map_path)
taxa_rp = replace_taxa("desmongnathus", "desmognathus", path = taxa_map_path)
taxa_rp = replace_taxa("desmoganthus", "desmognathus", path = taxa_map_path)
  ...
  taxa_map_out = taxa_map %>%
    left_join(t_aw %>%
                mutate(taxa_search = name_submitted,
                       ...
                       amphibiaweb_canonical_matched = scientific_name,
                       amphibiaweb_url = url) %>%
