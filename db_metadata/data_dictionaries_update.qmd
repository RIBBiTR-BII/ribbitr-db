...
## temp for rewriting constraints:
...
#   {
#     for (schema in schemas) {
#       mdc_final = meta_column_data_sup[[schema]] %>%
#         collect() %>%
#         mutate(across(everything(), ~ifelse(is.na(.), "", .)),
#                natural_key = as.logical(natural_key),
#                natural_key = ifelse(is.na(natural_key), FALSE, natural_key)) %>%
#         left_join(pg_column_data[[schema]], by = c("table_schema", "table_name", "column_name"))
#       
#       dbWriteTable(dbcon, Id(schema, "metadata_columns"), mdc_final, overwrite = TRUE)
#     }
#     
# 
# 
