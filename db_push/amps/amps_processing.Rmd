...
clean_peptide = bind_rows(raw_peptide_br_2022 %>%
                          ...
                          raw_peptide_pe_2023 %>%
                            rename(notes = Notes) %>%
                            mutate(notes = ifelse(!is.na(amp_id_2), paste0(notes,". Pooled fractions from: ", paste0(amp_id, amp_id_2, amp_id_3, amp_id_4)), notes)),
                          raw_peptide_sn_2022,
                          raw_peptide_sn_2023,
                          raw_peptide_sn_2024)
...
peace = raw_peptide_pe_2023 %>%
  rename(notes = "Notes") %>%
  mutate(notes = ifelse(!is.na(amp_id_2), paste0(notes,". Pooled fractions from: ", str_replace_na(c(amp_id, amp_id_2, amp_id_3, amp_id_4), collapse = ", ")), notes))
