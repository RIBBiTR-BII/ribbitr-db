  ...
  tryCatch(
    {
      ...
      # peak
      db_total = db_rows_upsert(dbcon, db_peak, upsert_peak, by="result_id")
      ...
      # intensity
      db_total = db_rows_upsert(dbcon, db_intensity, upsert_intensity, by="result_id")
      ...
      # gia
      db_total = db_rows_upsert(dbcon, db_gia, upsert_gia, by="result_id")
