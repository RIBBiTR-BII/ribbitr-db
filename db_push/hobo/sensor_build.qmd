...
tryCatch(
  {
    dbWriteTable(dbcon, Id("sensore_data", "logger"), subset_logger, overwrite = TRUE)
    dbWriteTable(dbcon, Id("sensor_data", "sensor"), subset_sensor, overwrite = TRUE)
    dbWriteTable(dbcon, Id("sensor_data", "time_series"), subset_obs, overwrite = TRUE)
