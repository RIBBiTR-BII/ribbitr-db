...
wddir = here(ddir, "panama", "fulcrum", "2025-09-23", "panama_field_3_0") # working data directory
...
if (x_capture) {
  ...
  tryCatch(
    {
      db_cmr = db_rows_update(dbcon, db_cmr, upsert_cmr, by="cmr_id")
      ...
      db_survey = db_rows_update(dbcon, db_survey, upsert_capture_survey, by="survey_id")
      ...
      db_taxa = db_rows_update(dbcon, db_taxa, insert_capture_taxa, by="taxon_id")
      ...
      db_capture = db_rows_update(dbcon, db_capture, upsert_capture, by="capture_id")
      ...
      db_sample = db_rows_update(dbcon, db_sample, upsert_sample_nc, by="sample_id")
