...
wddir = here(ddir, "fulcrum", 'panama', '2025-09-23', "panama_field_3_0") # working data directory
...
peace = get_dupes(subset_sample, sample_id)


upsert_sample_nc = upsert_sample %>%
  filter(negative_control)

upsert_sample_normal = upsert_sample %>%
  filter(!negative_control)
