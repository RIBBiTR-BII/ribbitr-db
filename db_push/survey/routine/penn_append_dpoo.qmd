...
wddir = here(ddir, "pennsylvania", "fulcrum", '2025-10-21') # working data directory
...
warning("Dropping all genetic samples from 2025 for now due to duplicate IDs (FIX ME!)")
gelled_sample = gelled_sample %>%
  filter(!(date >= "2025-01-01" & sample_type == "genetic"))
