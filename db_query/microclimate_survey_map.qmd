...
microclimate_subset_presurvey = function(survey_data, buffer, time_sensitive = FALSE, output_timezone = NA) {
  ...
  if (!is.na(output_timezone)) {
    ...
    tz_query = dbExecute(dbcon, paste0("SET TIME ZONE '",output_timezone , "';"))
  }
  ...
  if (!is.na(output_timezone)) {
    ...
    # set to passed time zone
    tz_query = dbExecute(dbcon, paste0("SET TIME ZONE '",session_tz , "';"))
  }
...
# call function
```{r}
test_1 = microclimate_subset_presurvey(data_ex, buffer = days(2), time_sensitive = FALSE, output_timezone = NA)
test_2 = microclimate_subset_presurvey(data_ex, buffer = days(14), time_sensitive = FALSE, output_timezone = NA)
test_3 = microclimate_subset_presurvey(data_ex, buffer = days(2), time_sensitive = TRUE, output_timezone = NA)
test_4 = microclimate_subset_presurvey(data_ex, buffer = days(2), time_sensitive = TRUE, output_timezone = "America/Los_Angeles")
```