...
schemas = read.csv(here("staging", "metadata","schemas.csv"))$x
  
  for (schema in schemas) {
    # Load dictionaries from file
    column_dict_write = read.csv(here("staging", "metadata", schema, "column_dict.csv"))
    bable_dict_write = read.csv(here("staging", "metadata", schema, "table_dict.csv"))
